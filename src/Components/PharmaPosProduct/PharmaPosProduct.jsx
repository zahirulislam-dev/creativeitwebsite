    ...
    <div className='bg-white pt-[235px] pb-[100px]'>
      <div className='max-w-container mx-auto'>
        <div className='flex justify-between items-center'>
          <h4 className='font-pops font-bold text-[28px] text-[#4CAF4F] mb-[20px]'>Pharmacy Shop Management Online POS Software</h4>
        ...
        <div className='flex justify-between'>
          <div className='mr-[50px]'>
            <div>
              ...
              <p className='font-pops font-medium text-[18px] text-overlay mb-[20px] w-[962px] leading-9'>You can use this software in Pharmacy shop/ showroom, general stores, super shops, department stores. You can sale medicine piece, stripe & box system. Many more features include purchase, sale, stock, purchase, staff, user & all-important report. This software will go a long way in making your business easier and more dynamic. It has a user-friendly design, in the Bengali / English language</p>
            </div>
