    ...
    <div className='bg-white pt-[235px] pb-[100px]'>
      <div className='max-w-container mx-auto'>
        <div className='flex justify-between items-center'>
          <h4 className='font-pops font-bold text-[28px] text-[#4CAF4F] mb-[20px]'>Factory, Production Accounting Management Erp Online Software</h4>
            ...
            <div className='flex justify-between border-t-2'>
              <div className='leading-9'>
                ...
                <div className='flex items-center'>
                  ...
                  <p className='font-pops font-regular text-[18px] text-overlay'>Setup Charge OneTime BDT.  85000/-</p>
                </div>
                <div className='flex items-center'>
                  <PiDotFill className='text-[25px] mr-[8px]'/>
