        ...
        <div className='max-w-container mx-auto px-[10px] xl:px-0'>
            <div className='xl:flex xl:justify-between xl:items-center'>
                <div>
                    ...
                    <img src={VideoIcon} alt="" className='xl:w-[1000px] xl:h-[500px] bg-[#fff] p-[10px]'/>
                </div>
                <div className='ml-0 xl:ml-[50px] mt-[30px] xl:mt-0'>
                    <p className='font-pops font-bold text-[25px] xl:text-[35px] text-[#000020] mb-[20px]'>Software ScreenShots</p>
                    <img src={screenshotCpos} alt="" className='xl:w-[1000px] xl:h-[500px] bg-[#fff] p-[10px]'/>
                </div>
            </div>
        </div>
    </div>
