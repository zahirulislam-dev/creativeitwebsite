    ...
    <div className='bg-white pt-[235px] pb-[100px]'>
      <div className='max-w-container mx-auto'>
        <div className='flex justify-between items-center'>
          <h4 className='font-pops font-bold text-[28px] text-[#4CAF4F] mb-[20px] w-[1076px]'>Fashion House, Footwear Store, Brand Shop Multiple Branch Management erp Online Software</h4>
        ...
        <div className='flex justify-between'>
            ...
            <div className='flex justify-between border-t-2'>
              <div className='leading-10'>
                ...
                <div className='flex items-center'>
                  ...
                  <p className='font-pops font-regular text-[18px] text-overlay'>Setup Charge for MainBranch OneTime BDT. 25000/-</p>
                </div>
                <div className='flex items-center'>
                  <PiDotFill className='text-[25px] mr-[8px]'/>
                  <p className='font-pops font-regular text-[18px] text-overlay'>Setup Charge for Every SubBranch OneTime BDT. 18000/-</p>
                </div>
                <div className='flex items-center'>
                  <PiDotFill className='text-[25px] mr-[8px]'/>
                ...
                <div className='flex items-center'>
                  <PiDotFill className='text-[25px] mr-[8px]'/>
                  <p className='font-pops font-regular text-[18px] text-overlay'>Server, Maintenance for Every Branch BDT. 12000/yearly</p>
                </div>
                <div className='flex items-center'>
                  <PiDotFill className='text-[25px] mr-[8px]'/>
              ...
              <div className='leading-10'>
                ...
                <div className='flex items-center'>
                  <PiDotFill className='text-[25px] mr-[8px]'/>
                  <p className='font-pops font-regular text-[18px] text-overlay'>Setup Charge MainBranch OneTime BDT. 15000/-</p>
                </div>
                <div className='flex items-center'>
                  <PiDotFill className='text-[25px] mr-[8px]'/>
                  <p className='font-pops font-regular text-[18px] text-overlay'>Setup Charge Every SubBranch OneTime BDT. 12000/-</p>
                </div>
                <div className='flex items-center'>
                  <PiDotFill className='text-[25px] mr-[8px]'/>
                ...
                <div className='flex items-center'>
                  <PiDotFill className='text-[25px] mr-[8px]'/>
                  <p className='font-pops font-regular text-[18px] text-overlay'>Server, Maintenance for Every Branch BDT. 1500/monthly</p>
                </div>
                <div className='flex items-center'>
                  <PiDotFill className='text-[25px] mr-[8px]'/>
                  <p className='font-pops font-regular text-[18px] text-overlay'>No hidden cost</p>
          ...
          <div className=''>
            <img src={bsPos} alt="" className='mt-[50px]' />
          </div>
        </div>
      </div>
    </div>
