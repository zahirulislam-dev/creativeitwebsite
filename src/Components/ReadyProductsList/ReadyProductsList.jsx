    ...
    return (
        <div className='bg-[#F5F7FA] pt-[210px] pb-[30px] md:pt-[170px] xl:pt-[235px] md:pb-[50px]'>
            <div className='max-w-container mx-auto px-[10px] xl:px-0'>
                <h5 className='font-pops font-bold text-[20px] md:text-[40px] xl:text-[64px] [#1C1E53]] mb-[20px] text-center'>Ready Products</h5>
                <h6 className='font-pops font-semibold text-[18px] text-center md:text-[30px] xl:text-[40px] text-[#1C1E53]'>List Of Our Readymade Softwares</h6>
                <div className='bg-[#fff] px-[20px] py-[30px] shadow rounded mt-[30px]'>
                    <div>
                            ...
                            <div className='flex-end'>
                                <Link to='/supershopDetails'>
                                    <div className='flex items-center bg-[#5F35F5] py-[14px] px-[20px] hover:bg-green-500 transition duration-300 ease-in-out rounded text-center'>
                                        <FaDownload className='text-white text-[18px] md:text-[20px] xl:text-[25px] ml-[28px] mr-[8px]' />
                                ...
                                <div className='flex items-center bg-[#000020] py-[14px] px-[20px] hover:bg-red-500 transition duration-300 ease-in-out rounded mt-[20px]'>
                                    ...
                                    <button className='font-pops font-bold text-[18px] md:text-[20px] xl:text-[25px] text-white'>ScreenShots</button>
                                </div>
                                <div className='flex items-center bg-[#4CAF4F] py-[14px] px-[20px] hover:bg-[#5656f6] transition duration-300 ease-in-out rounded mt-[20px]'>
                                    <FaVideo className='text-white text-[25px] ml-[28px] mr-[8px]' />
                                    <button className='font-pops font-bold text-[18px] md:text-[20px] xl:text-[25px] text-white'>Videos</button>
                                </div>
                            </div>
                        </div>
                        <div className='md:flex md:justify-end items-center border-t-2'>
                            ...
                            <p className='font-pops font-bold text-[16px] md:text-[18px] text-[#1C1E53] pt-[10px] ml-[8px] md:ml-[20px]'>Version: V-2.0.1</p>
                        </div>
                    </div>
                </div>
                <div className='bg-[#fff] px-[20px] py-[30px] shadow rounded mt-[30px]'>
                        ...
                        <div className='xl:flex xl:justify-between'>
                            <div className='xl:flex'>
                                ...
                                <div>
                                    ...
                                    <p className='font-pops font-medium text-[16px] md:text-[18px] text-overlay mb-[50px] xl:w-[1032px] leading-9'>You can use this version of the software at any shop/ showroom. For an example: Grocery, Deparment, Hardware, Cosmetics, Furniture, Parts, Retail & Whole Sale all shop etc. Reliable customer service will be ensured at all times. This software is available in both Bengali and English languages. The software will be a Highly user-friendly interface with slow internet speed. The entire software is our own written code and designed using the suggestions from the respective sectors to develop it. The software will be helpful for your organization.</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                            <div className='xl:flex-end'>
                                <Link to='/cposDetails'>
                                    <div className='flex items-center bg-[#5F35F5] py-[14px] px-[20px] hover:bg-green-500 transition duration-300 ease-in-out rounded text-center'>
                                        <FaDownload className='text-white text-[25px] ml-[28px] mr-[8px]' />
                                        <button className='font-pops font-bold text-[18px] xl:text-[20px] text-white'>Details</button>
                                    </div>
                                </Link>
                                <div className='flex items-center bg-[#000020] py-[14px] px-[20px] hover:bg-red-500 transition duration-300 ease-in-out rounded mt-[20px]'>
                                    <HiPhoto className='text-white text-[25px] mr-[8px]' />
                                    <button className='font-pops font-bold text-[18px] xl:text-[20px] text-white'>ScreenShots</button>
                                </div>
                                <div className='flex items-center bg-[#4CAF4F] py-[14px] px-[20px] hover:bg-[#5656f6] transition duration-300 ease-in-out rounded mt-[20px]'>
                                    <FaVideo className='text-white text-[25px] ml-[28px] mr-[8px]' />
                                    <button className='font-pops font-bold text-[18px] xl:text-[20px] text-white'>Videos</button>
                                </div>
                            </div>
                        </div>
                        <div className='md:flex md:justify-end items-center border-t-2'>
                            <p className='font-pops font-bold text-[16px] xl:text-[18px] text-[#1C1E53] pt-[10px]'>Last Update: 2022-08-02</p>
                            <p className='font-pops font-bold text-[16px] xl:text-[18px] text-[#1C1E53] pt-[10px] ml-[8px] md:ml-[20px]'>Version: V-2.0.1</p>
                        </div>
                    </div>
                </div>
                <div className='bg-[#fff] px-[20px] py-[30px] shadow rounded mt-[30px]'>
                    <div>
                        <div className='xl:flex xl:justify-between'>
                            <div className='xl:flex'>
                                ...
                                <div>
                                    ...
                                    <p className='font-pops font-medium text-[16px] xl:text-[18px] text-overlay mb-[50px] xl:w-[1032px] leading-9'>You can use this version of the software at any ready garments shop, boutick house shop, footwear shop. Reliable customer service will be ensured at all times. This software is available in both Bengali and English languages. The software will be a Highly user-friendly interface with slow internet speed. The entire software is our own written code and designed using the suggestions from the respective sectors to develop it. The software will be helpful for your organization.</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                        ...
                        <div className='md:flex md:justify-end items-center border-t-2'>
                            ...
                            <p className='font-pops font-bold text-[16px] md:text-[18px] text-[#1C1E53] pt-[10px] ml-[8px] md:ml-[20px]'>Version: V-1.0.0</p>
                        </div>
                    </div>
                </div>
                <div className='bg-[#fff] px-[20px] py-[30px] shadow rounded mt-[30px]'>
                    <div>
                        <div className='xl:flex xl:justify-between'>
                            ...
                            <div className='xl:flex-end'>
                                <Link to='/BsMultibranchPosDetails'><div className='flex items-center bg-[#5F35F5] py-[14px] px-[20px] hover:bg-green-500 transition duration-300 ease-in-out rounded text-center'>
                                    <FaDownload className='text-white text-[25px] ml-[28px] mr-[8px]' />
                                    <button className='font-pops font-bold text-[18px] xl:text-[20px] text-white'>Details</button>
                                </div>
                                </Link>
                        ...
                        <div className='flex justify-end items-center border-t-2'>
                            ...
                            <p className='font-pops font-bold text-[16px] xl:text-[18px] text-[#1C1E53] pt-[10px] ml-[8px] xl:ml-[20px]'>Version: V-1.0.0</p>
                        </div>
                    </div>
                </div>
                <div className='bg-[#fff] px-[20px] py-[30px] shadow rounded mt-[30px]'>
                        ...
                        <div className='xl:flex xl:justify-between'>
                            <div className='xl:flex'>
                                ...
                                <div>
                                    ...
                                    <p className='font-pops font-medium text-[16px] xl:text-[18px] text-overlay mb-[50px] xl:w-[1032px] leading-9'>You can use this software in Pharmacy shop/ showroom, general stores, super shops, department stores. You can sale medicine piece, stripe & box system. This software will go a long way in making your business easier and more dynamic. It has a user-friendly design, in the Bengali / English language.</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                            <div className='xl:flex-end'>
                                <Link to='/PharmaPosDetails'><div className='flex items-center bg-[#5F35F5] py-[14px] px-[20px] hover:bg-green-500 transition duration-300 ease-in-out rounded text-center'>
                                    <FaDownload className='text-white text-[25px] ml-[28px] mr-[8px]' />
                                    <button className='font-pops font-bold text-[18px] xl:text-[20px] text-white'>Details</button>
                                </div>
                                </Link>
                        ...
                        <div className='xl:flex xl:justify-between'>
                            <div className='xl:flex'>
                                ...
                                <div>
                                    ...
                                    <p className='font-pops font-medium text-[16px] xl:text-[18px] text-overlay mb-[50px] xl:w-[1032px] leading-9'>You can use this software in tiles and sanitary shop and dealer points. Many more features include purchase, sale, stock, purchase, seller, staff, user & all-important report. This software will go a long way in making your business easier and more dynamic. It has a user-friendly design, in the Bengali / English language.</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                            <div className='xl:flex-end'>
                                <Link to='/TilesanitaryPosDetails'><div className='flex items-center bg-[#5F35F5] py-[14px] px-[20px] hover:bg-green-500 transition duration-300 ease-in-out rounded text-center'>
                                    <FaDownload className='text-white text-[25px] ml-[28px] mr-[8px]' />
                                    <button className='font-pops font-bold text-[18px] xl:text-[20px] text-white'>Details</button>
                                </div>
                                </Link>
                        ...
                        <div className='xl:flex xl:justify-between'>
                            <div className='xl:flex'>
                                ...
                                <div>
                                    ...
                                    <p className='font-pops font-medium text-[16px] xl:text-[18px] text-overlay mb-[50px] xl:w-[1032px] leading-9'>You can use this software in electronics, mobile showrooms, computer sales and servicing shop. Many more features include purchase, sale, stock, purchase, seller, staff, user & all-important reports. This software will go a long way in making your business easier and more dynamic. It has a user-friendly design, in the Bengali / English language.</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                        ...
                        <div className='xl:flex xl:justify-between'>
                            <div className='xl:flex'>
                                ...
                                <div>
                                    ...
                                    <p className='font-pops font-medium text-[16px] xl:text-[18px] text-overlay mb-[50px] xl:w-[1032px] leading-9'>You can use this version of the software at any restaurant, community center, convention hall, cafe, coffee shop etc. Reliable customer service will be ensured at all times. This software is available in both Bengali and English languages. The software will be a Highly user-friendly interface with slow internet speed. The entire software is our own written code and designed using the suggestions from the respective sectors to develop it. the software will be helpful for your organization.</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                        ...
                        <div className='xl:flex xl:justify-between'>
                            <div className='xl:flex'>
                                ...
                                <div>
                                    ...
                                    <p className='font-pops font-medium text-[16px] xl:text-[18px] text-overlay mb-[50px] xl:w-[1032px] leading-9'>You can use this version of the software at LPG Dealership & Distribution business. Reliable customer service will be ensured at all times. This software is available in both Bengali and English languages. The software will be a Highly user-friendly interface with slow internet speed. The entire software is our own written code and designed using the suggestions from the respective sectors to develop it. The software will be helpful for your organization.</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                            <div className='xl:flex-endflex-end'>
                        ...
                        <div className='xl:flex xl:justify-between'>
                            <div className='xl:flex'>
                                ...
                                <div>
                                    ...
                                    <p className='font-pops font-medium text-[16px] xl:text-[18px] text-overlay mb-[50px] xl:w-[1032px] leading-9'>You can use this version of the software at Agro farm, Poultry farm. Reliable customer service will be ensured at all times. This software is available in both Bengali and English languages. The software will be a Highly user-friendly interface with slow internet speed. The entire software is our own written code and designed using the suggestions from the respective sectors to develop it. The software will be helpful for your organization.</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                        ...
                        <div className='xl:flex xl:justify-between'>
                            <div className='xl:flex'>
                                ...
                                <div>
                                    ...
                                    <p className='font-pops font-medium text-[16px] xl:text-[18px] text-overlay mb-[50px] xl:w-[1032px] leading-9'>You can use this version of the software at Computer training center, Coaching center, Language trainging center, Jim center, Martual training center very easily. Training Center Management Software. Admission Fees Receive Course & Batch Information ID Card and Certificate Attendance Expenditure Instructor Profile Notice, News and Blog Publish SMS Alert Reports</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[16px] xl:text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                    ...
                    <div>
                        <div className='flex justify-between'>
                            <div className='flex'>
                                ...
                                <div>
                                    <h5 className='font-pops font-semibold text-[20px] text-[#4CAF4F] mb-[20px]'>Education Institute Management Online Software</h5>
                                    <p className='font-pops font-medium text-[18px] text-overlay mb-[50px] w-[1032px] leading-9'>You can use this version of the software at any education institute like school, college, madrasah, kindergarten etc. Reliable customer service will be ensured at all times. This software is available in both Bengali and English languages. The software will be a Highly user-friendly interface with slow internet speed. The entire software is our own written code and designed using the suggestions from the respective sectors to develop it. the software will be helpful for your organization.</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                            <div className='flex-end'>
                    ...
                    <div>
                        <div className='flex justify-between'>
                            <div className='flex'>
                                ...
                                <div>
                                    <h5 className='font-pops font-semibold text-[20px] text-[#4CAF4F] mb-[20px]'>Factory, Production Accounting Management Erp Online Software</h5>
                                    <p className='font-pops font-medium text-[18px] text-overlay mb-[50px] w-[1032px] leading-9'>You can use this version of the software at any manufacturing business solution company, Production Factory, Furniture factory, Food factory, Chemical factory, Electric & Electronics item production factory etc. Reliable customer service will be ensured at all times. This software is available in both Bengali and English languages. The software will be a Highly user-friendly interface with slow internet speed. The entire software is our own written code and designed using the suggestions from the respective sectors to develop it. The software will be helpful for your organization.</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                    ...
                    <div>
                        <div className='flex justify-between'>
                            <div className='flex'>
                                ...
                                <div>
                                    <h5 className='font-pops font-semibold text-[20px] text-[#4CAF4F] mb-[20px]'>Brick Field Manufacturing Accounting Management Online Software</h5>
                                    <p className='font-pops font-medium text-[18px] text-overlay mb-[50px] w-[1032px] leading-9'>You can use this version of the software at Brick Field. Reliable customer service will be ensured at all times. This software is available in both Bengali and English languages. The software will be a Highly user-friendly interface with slow internet speed. The entire software is our own written code and designed using the suggestions from the respective sectors to develop it. The software will be helpful for your organization.</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                    ...
                    <div>
                        <div className='flex justify-between'>
                            <div className='flex'>
                                ...
                                <div>
                                    <h5 className='font-pops font-semibold text-[20px] text-[#4CAF4F] mb-[20px]'>Accounting Management Online Software</h5>
                                    <p className='font-pops font-medium text-[18px] text-overlay mb-[50px] w-[1032px] leading-9'>You can use this version of the software at any business organisations for accounting. Ledger, Cash Book, Statement, Balance Sheet etc. Reliable customer service will be ensured at all times. This software is available in both Bengali and English languages. The software will be a Highly user-friendly interface with slow internet speed. The entire software is our own written code and designed using the suggestions from the respective sectors to develop it. the software will be helpful for your organization.</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                    ...
                    <div>
                        <div className='flex justify-between'>
                            <div className='flex'>
                                ...
                                <div>
                                    <h5 className='font-pops font-semibold text-[20px] text-[#4CAF4F] mb-[20px]'>Office Management System Online Software</h5>
                                    <p className='font-pops font-medium text-[18px] text-overlay mb-[50px] w-[1032px] leading-9'>You can use this version of the software at any office. Reliable customer service will be ensured at all times. This software is available in both Bengali and English languages. The software will be a Highly user-friendly interface with slow internet speed. The entire software is our own written code and designed using the suggestions from the respective sectors to develop it. The software will be helpful for your organization.</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                    ...
                    <div>
                        <div className='flex justify-between'>
                            <div className='flex'>
                                ...
                                <div>
                                    <h5 className='font-pops font-semibold text-[20px] text-[#4CAF4F] mb-[20px]'>Diagnostic Center Management Online Software</h5>
                                    <p className='font-pops font-medium text-[18px] text-overlay mb-[50px] w-[1032px] leading-9'>This software is designed to help Diagnostic professionals manage their daily tasks, streamline processes, and improve patient care. These software programs can include electronic medical records (EMRs), patient scheduling systems, billing and insurance management tools, and clinical decision support systems. They can also help improve patient outcomes by providing doctors with real-time access to patient data and medical histories, as well as facilitating communication and collaboration between healthcare professionals. Overall, hospital, diagnostic, and clinic software are essential tools for healthcare organizations looking to provide high-quality care and streamline their operations.</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                    ...
                    <div>
                        <div className='flex justify-between'>
                            <div className='flex'>
                                ...
                                <div>
                                    <h5 className='font-pops font-semibold text-[20px] text-[#4CAF4F] mb-[20px]'>Stock Inventory Management Online Software</h5>
                                    <p className='font-pops font-medium text-[18px] text-overlay mb-[50px] w-[1032px] leading-9'>You can use this version of the software at any Products raw material store. Reliable customer service will be ensured at all times. This software is available in both Bengali and English languages. The software will be a Highly user-friendly interface with slow internet speed. The entire software is our own written code and designed using the suggestions from the respective sectors to develop it. The software will be helpful for your organization.</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
                    ...
                    <div>
                        <div className='flex justify-between'>
                            <div className='flex'>
                                ...
                                <div>
                                    <h5 className='font-pops font-semibold text-[20px] text-[#4CAF4F] mb-[20px]'>Internet and Cable Operator Billing Management Online Software</h5>
                                    <p className='font-pops font-medium text-[18px] text-overlay mb-[50px] w-[1032px] leading-9'>You can use this version of the software at internet business & disc line business. Reliable customer service will be ensured at all times. This software is available in both Bengali and English languages. The software will be a Highly user-friendly interface with slow internet speed. The entire software is our own written code and designed using the suggestions from the respective sectors to develop it. The software will be helpful for your organization.</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 leading-5'>Language: English & Bangla</p>
                                    <p className='font-pops font-bold text-[18px] text-red-500 mt-[20px] mb-[20px] leading-5'>Network Mode: Online <span className='ml-[8px]'>Responsive</span></p>
                                </div>
                            </div>
