            ...
            <div className='max-w-container mx-auto px-[10px] xl:px-0'>
                <div className='md:flex md:flex-wrap xl:justify-between'>
                    <div className='mb-[30px] xl:mb-0'>
                        <h5 className='font-pops font-bold text-[25px] text-[#fff] mb-[25px]'>Contact Address</h5>
                        ...
                        <div className='flex mb-[15px] align-baseline'>
                            <FaSearchLocation className='text-[22px] text-white' />
                            <p className='font-pops font-regular text-[16px] text-[#fff] ml-[10px] w-[310px]'>
                                Kassaf Shopping Center (5th Floor), Chittagong Road, Narayanganj, Dhaka, Bangladesh.
                            </p>
                        </div>
                        <div className='flex align-baseline mb-[34px]'>
                            <BiSolidLockOpen className='text-[22px] text-white' />
                            <p className='font-pops font-regular text-[16px] text-[#fff] ml-[10px] w-[165px]'>
                                Friday To Saturday <span>10:00 AM To 10:00 PM</span>
                            </p>
                        </div>
                    ...
                    <div className='mb-[30px] xl:mb-0'>
                        <h5 className='font-pops font-bold text-[25px] text-[#fff] mb-[25px]'>About Us</h5>
                        <p className='font-pops font-regular text-[16px] text-[#fff] xl:w-[511px]'>
                    ...
                    <div className='mb-[30px] xl:mb-0'>
                        <h5 className='font-pops font-bold text-[25px] text-[#fff] mb-[21px]'>Our Services</h5>
                    ...
                    <div className='xl:mb-0 md:ml-[50px] xl:ml-0'>
                        <h5 className='font-pops font-bold text-[25px] text-[#fff] mb-[21px]'>Others</h5>
                        <div className='leading-10'>
