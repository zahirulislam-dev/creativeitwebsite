            ...
            <div className='max-w-container mx-auto px-[10px] xl:px-0'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[30px]'>
                    <div className='bg-[#fff] px-[20px] py-[30px] shadow rounded'>
                        <div className=''>
                            <img src={zahir} alt="" className='w-[200px] h-[200px] rounded-full mx-auto mb-[10px]' />
                    ...
                    <div className='bg-[#fff] px-[20px] py-[30px] shadow rounded'>
                        <div className=''>
                            <img src={softwareDev} alt="" className='w-[200px] h-[200px] rounded-full mx-auto mb-[10px]' />
